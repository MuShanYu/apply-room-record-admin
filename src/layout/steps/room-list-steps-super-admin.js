const steps = [
  ...
  {
    element: '#room-room-operate-apply',
    popover: {
      title: '禁止预约',
  ...
  {
    element: '#room-room-select-filter',
    popover: {
      title: '列表删选条件',
  ...
  {
    element: '#room-room-operate-qr-code',
    popover: {
      title: '生成房间二维码',
